    ...
    def connect(self):
       # Checking if the User is logged in
        if self.scope["user"].is_anonymous:
            ...
            self.group_name = "tes"  # Setting the group name as the pk of the user primary key as it is unique to each user. The group name is used to communicate with the user.
